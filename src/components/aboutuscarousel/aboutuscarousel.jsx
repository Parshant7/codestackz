import teamTogether from '/images/ourteam/aboutusteam.webp'
import AOS from 'aos'
                    ...
                    <div className='row ' style={{ height: "100%" }}>
                        <div className="col-md-12 col-lg-12 p-0 mx-auto ">
                            <div className="mx-auto " style={{ width: "fit-content" }}>
                                ...
                                <p className=' '>Embrace innovation and elevate your company's trajectory with our specialized development solutions.</p>
                            </div>
                        </div>
                    </div>
                </div>
